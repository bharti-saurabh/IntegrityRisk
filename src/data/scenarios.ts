...
export const SCENARIO_SPECS: ScenarioSpec[] = [
  ...
  {
    scenarioId: "fake-descriptor-brand-mimic",
    merchantId: "M-15220",
    title: "Fake descriptor mimicking a national retailer",
    primaryTypology: "FAKE_DESCRIPTOR",
    story:
      "Descriptor closely mimics a well-known national retailer while the legal name is unrelated; descriptor changed five times and disputes cite 'merchant not recognized'.",
    expectedSignals: [
      "brand impersonation",
      "low descriptor-to-legal-name similarity",
      "frequent descriptor changes",
      "high not-recognized dispute rate",
    ],
    declaredMcc: "5999",
    actualMcc: "5967",
    legalName: "Sterling Digital Holdings LLC",
    tradeName: "Sterling Digital",
    descriptor: "WALMartT SUPERCTR",
    city: "Phoenix",
    state: "AZ",
    overrides: { brandMimic: "WALMART SUPERCENTER", descriptorCount: 5 },
  },
  {
